...
namespace Playcipe
{
    public partial class Form1 : Form
    {
        ...
        private async void Form1_Load(object sender, EventArgs e)
        {
            ...
            Task.Run(() => Loader());
            CoreWebView2EnvironmentOptions options = new CoreWebView2EnvironmentOptions("--enable-web-security --disable-gpu-driver-bug-workarounds --ignore-gpu-blocklist", "en");
