...
namespace Playcipe
{
    public partial class Form1 : Form
    {
        ...
        private async void Form1_Shown(object sender, EventArgs e)
        {
            ...
            x = 50;
            y = 25;
            cx = Screen.PrimaryScreen.Bounds.Width - 100;
            ...
            try
            {
                string stringinject = @"
                    if (window.location.href.indexOf('youtube') > -1 | window.location.href.indexOf('youtu.be') > -1) {
                        ...
                        var stringinject = `
                        <style>
                            .ad-showing, .ad-container, .ytp-ad-overlay-open, .video-ads, .ytp-ad-overlay-image, .ytp-ad-overlay-container, .ytd-carousel-ad-renderer, ytd-ad-slot-renderer, ytd-action-companion-ad-renderer, ytd-engagement-panel-section-list-renderer {
